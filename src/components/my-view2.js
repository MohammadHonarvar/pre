...
class MyView2 extends PageViewElement {
  ...
  render() {
    return html`
      ...
      <div class="img-div">
        <img src="../../images/1606-GenesisMintConcept.jpg" width="600" height="400" class="new-img" />
        <img src="../../images/2447e017e092341dfd24bb0c925f7883.jpg" width="600" height="400" class="new-img" />
      </div>
    `;
  }
