...
class MyView5 extends PageViewElement {
  ...
  render() {
    return html`
        <p>
          <img name="usaMap" src="../../images/single-product-type-1.jpg" usemap="#m_usaMap" border="0" width="100%">
        </p>
        
        <map name="m_usaMap">
          <!-- A -->
          <area shape="poly" coords="65 365,941 365,941 1045,65 1045" href="view4" title="Alabama">
        </map>
    `;
  }
}
